...
//  Underbored
//
//  Created by Peter Guan Li on 10/13/15.
...
protocol AccountsTableViewCellDelegate {
    func userHasLiked(accountsTableViewCell: AccountsTableViewCell)
}
...
class AccountsTableViewCell: UITableViewCell {
    ...
    var delegate: AccountsTableViewCellDelegate?
    ...
    */
    func setCell(forumPost: ForumPost) {
        ...
        forumTitleTextView.editable = false
