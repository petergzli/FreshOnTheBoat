...
COPY forum_profile (created_by, description, category, title, location, latitude, longitude, created_at, image_url, forum_post_flagged, location_pin_latitude, location_pin_longitude, id) FROM stdin;
2	I love fried chicken guys... 	3	Where can I get some chicken around here?		34.0671239999999997	-118.444792000000007	2015-10-04		\N	34.0671239999999926	-118.444792000000007	1
\.
...
SELECT pg_catalog.setval('forum_profile_likes_id_seq', 1, false);
...
SELECT pg_catalog.setval('forum_profile_postings_id_seq', 1, false);
...
callmemaybe			callmemaybe@gmail.com	$6$rounds=665335$uAIfJoRQ.hBs3GL3$4azW10Y.aUL.pVKEhqJYZE7fq87zUxJbJnIuXHFdNlbBLg9lMmGLJj0QG9TU1sth2CtIkXRsMsnhMtiW1P8hY.	\N	eyJhbGciOiJIUzI1NiIsImV4cCI6MTQ0Mzk4NzA5OCwiaWF0IjoxNDQzOTg2NDk4fQ.eyJpZCI6MX0.4OEk95ovxZrEyYi_s3amAAuUdEgl1dANCdbl68JeMHM	\N	\N	\N	\N	\N	\N	\N	1
